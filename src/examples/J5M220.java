 ...
 * @author imamah
 */
public class J5M220 extends javax.swing.JFrame {
    String loggedIn;
    JFrame prev;
    /**
     * Creates new form ShoesAndBags
     */
    public J5M220(String email, JFrame p) {
         setVisible(true);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 40, 690));
        ...
        jLabel21.setText("J5M-220 Super Plus (6x2) Prime Mover");
        jPanel4.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 40, 670, 40));

        getContentPane().add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 50, 910, 112));
        ...
        getContentPane().add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 0, 960, 50));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/examples/j5m details.PNG"))); // NOI18N
        jLabel2.setText(" ");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 160, 910, 530));
