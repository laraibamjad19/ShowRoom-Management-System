 ...
 * @author imamah
 */
public class J5M420 extends javax.swing.JFrame {
    String loggedIn;
    JFrame prev;
    /**
     * Creates new form ShoesAndBags
     */
    public J5M420(String email, JFrame p) {
         setVisible(true);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 40, 910));
        ...
        jLabel21.setText(" FAW J5P-420 PM");
        jPanel4.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 40, 310, 40));

        getContentPane().add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 50, 490, 112));
        ...
        getContentPane().add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 0, 540, 50));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/examples/details 420.PNG"))); // NOI18N
        jLabel2.setText(" ");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 160, 460, 750));
