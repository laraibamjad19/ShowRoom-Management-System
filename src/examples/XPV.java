 ...
 * @author imamah
 */
public class XPV extends javax.swing.JFrame {
    String loggedIn;
    JFrame prev;
    /**
     * Creates new form ShoesAndBags
     */
    public XPV(String email, JFrame p) {
         setVisible(true);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 50, 1030, 100));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/examples/DETAILXPV1.PNG"))); // NOI18N
        jLabel2.setText(" ");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 150, 570, 640));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/examples/XPVDETAILS2.PNG"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 150, 460, 370));
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 520, 460, 270));
